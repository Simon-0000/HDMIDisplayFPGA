...
create_generated_clock -name clk_hpram_in -source [get_ports {clk}] -multiply_by 4 [get_pins {pll_hyperram/pllvr_inst/CLKOUT}] 
create_generated_clock -name clk_hpram_out -source [get_ports {clk}] -multiply_by 2 [get_pins {pll_hyperram/pllvr_inst/CLKOUTD}]
